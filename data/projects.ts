...
export const projects: Project[] = [
  {
    ...
    longDescription:
      'Desenvolvimento de um site institucional moderno com foco em performance e experiência do usuário. Design clean e minimalista que reflete a identidade da marca.',
  ...
  },
  {
    ...
    longDescription:
      'Landing page otimizada para conversão, com elementos estrategicamente posicionados e copywriting persuasivo. Interface moderna e responsiva.',
  ...
  },
  {
    ...
    longDescription:
      'E-commerce desenvolvido com foco na experiência do usuário, incluindo checkout otimizado, filtros inteligentes e recomendações personalizadas.',
  ...
  },
  {
    ...
    longDescription:
      'Sistema web robusto para gestão empresarial com módulos personalizados, dashboards interativos e relatórios avançados.',
  ...
  },
  {
    ...
    longDescription:
      'Design system completo com componentes reutilizáveis, documentação detalhada e guias de estilo para garantir consistência visual.',
